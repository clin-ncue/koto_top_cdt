//altlvds_tx CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" COMMON_RX_TX_PLL="ON" DESERIALIZATION_FACTOR=16 DEVICE_FAMILY="Stratix II" ENABLE_CLK_LATENCY="ON" IMPLEMENT_IN_LES="ON" INCLOCK_PERIOD=32000 INCLOCK_PHASE_SHIFT=0 NUMBER_OF_CHANNELS=1 OUTCLOCK_RESOURCE="AUTO" OUTPUT_DATA_RATE=500 REGISTERED_INPUT="OFF" USE_EXTERNAL_PLL="OFF" USE_NO_PHASE_SHIFT="ON" tx_in tx_inclock tx_out CARRY_CHAIN="IGNORE" CARRY_CHAIN_LENGTH=48
...
//CBXI_INSTANCE_NAME="sigma_delta_CL_ALTLVDS_Tx_1_inst123_altlvds_tx_altlvds_tx_component"
...
module  CL_ALTLVDS_Tx_1_altclkctrl
	( 
	inclk,
...
`endif
	...
	assign
		...
		inclk_wire = {inclk},
		outclk = wire_clkctrl14_outclk;
endmodule //CL_ALTLVDS_Tx_1_altclkctrl


//altddio_out CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEVICE_FAMILY="Stratix II" WIDTH=1 datain_h datain_l dataout outclock
//VERSION_BEGIN 9.1SP2 cbx_altddio_out 2010:03:24:20:38:24:SJ cbx_cycloneii 2010:03:24:20:38:24:SJ cbx_mgl 2010:03:24:21:00:10:SJ cbx_stratix 2010:03:24:20:38:24:SJ cbx_stratixii 2010:03:24:20:38:24:SJ cbx_stratixiii 2010:03:24:20:38:24:SJ  VERSION_END
...
module  CL_ALTLVDS_Tx_1_ddio_out
	( 
	datain_h,
	datain_l,
	dataout,
	...
	defparam
		...
		ddio_outa_0.output_async_reset = "none",
...
endmodule //CL_ALTLVDS_Tx_1_ddio_out


//lpm_compare CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEVICE_FAMILY="Stratix II" LPM_WIDTH=3 aeb dataa datab
...
endmodule //CL_ALTLVDS_Tx_1_cmpr


//lpm_counter CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEVICE_FAMILY="Stratix II" lpm_modulus=8 lpm_width=3 clock q updown
...
`endif
	...
	wire  [2:0]   wire_counter_reg_bit15a_adatasdata;
	wire  [2:0]   wire_counter_reg_bit15a_regout;
	wire  aclr_actual;
	wire clk_en;
	wire cnt_en;
	wire [2:0]  data;
	...
	.combout(),
	.cout(),
	.datad(wire_counter_reg_bit15a_regout[2:2]),
	.dataf(updown_other_bits),
	.shareout(),
	...
	stratixii_lcell_ff   counter_reg_bit15a_2
	( 
	.aclr(aclr_actual),
	.adatasdata(wire_counter_reg_bit15a_adatasdata[2:2]),
	.clk(clock),
	.datain(wire_counter_comb_bita_2sumout[0:0]),
	.ena((clk_en & (((cnt_en | sclr) | sset) | sload))),
	.regout(wire_counter_reg_bit15a_regout[2:2]),
	.sclr(sclr),
	.sload((sset | sload)),
	.aload(1'b0)
	// synopsys translate_off
	...
	assign
		wire_counter_reg_bit15a_adatasdata = (({3{sset}} & s_val) | ({3{(~ sset)}} & data));
	assign
		aclr_actual = 1'b0,
		clk_en = 1'b1,
		cnt_en = 1'b1,
...
endmodule //CL_ALTLVDS_Tx_1_cntr


//lpm_shiftreg CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" LPM_DIRECTION="RIGHT" LPM_WIDTH=8 clock data load shiftin shiftout
//VERSION_BEGIN 9.1SP2 cbx_lpm_shiftreg 2010:03:24:20:38:24:SJ cbx_mgl 2010:03:24:21:00:10:SJ  VERSION_END

//synthesis_resources = reg 8 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  CL_ALTLVDS_Tx_1_shift_reg
	( 
	clock,
	data,
	load,
...
endmodule //CL_ALTLVDS_Tx_1_shift_reg

//synthesis_resources = clkctrl 1 lut 3 reg 39 stratixii_io 1 stratixii_pll 1 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
...
module  CL_ALTLVDS_Tx_1_lvds_tx
	...
	wire  load_signal;
	wire  slow_clock;
	wire  [15:0]  tx_in_wire;

	CL_ALTLVDS_Tx_1_altclkctrl   coreclk_buf
	( 
	.inclk({{3{1'b0}}, wire_lvds_tx_pll_clk[1]}),
	.outclk(wire_coreclk_buf_outclk));
	CL_ALTLVDS_Tx_1_ddio_out   ddio_out
	( 
	.datain_h(l_input),
	.datain_l(h_input),
	...
	CL_ALTLVDS_Tx_1_cmpr   cmpr10
	( 
	.aeb(wire_cmpr10_aeb),
	.dataa(dffe4a),
	.datab(dffe8a));
	CL_ALTLVDS_Tx_1_cmpr   cmpr9
	( 
	.aeb(wire_cmpr9_aeb),
	.dataa(dffe3a),
	.datab(dffe7a));
	CL_ALTLVDS_Tx_1_cntr   cntr2
	( 
	.clock(fast_clock),
	.q(wire_cntr2_q),
	.updown(sync_dffe1a));
	CL_ALTLVDS_Tx_1_shift_reg   shift_reg12
	( 
	.clock(fast_clock),
	.data({tx_in_wire[1], tx_in_wire[3], tx_in_wire[5], tx_in_wire[7], tx_in_wire[9], tx_in_wire[11], tx_in_wire[13], tx_in_wire[15]}),
	.load(load_signal),
	.shiftin(1'b0),
	.shiftout(wire_shift_reg12_shiftout));
	CL_ALTLVDS_Tx_1_shift_reg   shift_reg13
	( 
	.clock(fast_clock),
	.data({tx_in_wire[0], tx_in_wire[2], tx_in_wire[4], tx_in_wire[6], tx_in_wire[8], tx_in_wire[10], tx_in_wire[12], tx_in_wire[14]}),
	.load(load_signal),
	.shiftin(1'b0),
	...
	defparam
		...
		lvds_tx_pll.clk0_multiply_by = 8,
		lvds_tx_pll.clk0_phase_shift = "0",
		lvds_tx_pll.clk1_divide_by = 16,
		lvds_tx_pll.clk1_multiply_by = 16,
		lvds_tx_pll.clk1_phase_shift = "0",
