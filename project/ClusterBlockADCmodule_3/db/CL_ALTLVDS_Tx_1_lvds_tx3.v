...
//CBXI_INSTANCE_NAME="sigma_delta_CL_ALTLVDS_Tx_1_inst128_altlvds_tx_altlvds_tx_component"
...
(* ALTERA_ATTRIBUTE = {"{-to pll} AUTO_MERGE_PLLS=OFF;-name MULTICYCLE 7 -from txreg* -to tx*;-name MULTICYCLE_HOLD 8 -from txreg* -to tx*"} *)
module  CL_ALTLVDS_Tx_1_lvds_tx3
	( 
	pll_areset,
	tx_in,
	tx_inclock,
...
`endif
	...
	assign
		...
		tx_pll_enable = 1'b1;
endmodule //CL_ALTLVDS_Tx_1_lvds_tx3
//VALID FILE
