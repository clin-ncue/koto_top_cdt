...
module  CL_ALTLVDS_Tx_1_altclkctrl1
	( 
	inclk,
...
`endif
	...
	assign
		...
		inclk_wire = {inclk},
		outclk = wire_clkctrl14_outclk;
endmodule //CL_ALTLVDS_Tx_1_altclkctrl1
...
module  CL_ALTLVDS_Tx_1_ddio_out1
	( 
	datain_h,
	datain_l,
	dataout,
...
endmodule //CL_ALTLVDS_Tx_1_ddio_out1
...
endmodule //CL_ALTLVDS_Tx_1_cmpr1


//lpm_counter CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEVICE_FAMILY="Stratix II" lpm_modulus=4 lpm_width=2 clock q updown
...
endmodule //CL_ALTLVDS_Tx_1_cntr1
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  CL_ALTLVDS_Tx_1_shift_reg1
	( 
	clock,
	data,
	load,
...
endmodule //CL_ALTLVDS_Tx_1_shift_reg1

//synthesis_resources = clkctrl 1 lut 2 reg 24 stratixii_io 1 stratixii_pll 1 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"{-to lvds_tx_pll} AUTO_MERGE_PLLS=ON"} *)
module  CL_ALTLVDS_Tx_1_lvds_tx1
	( 
	tx_in,
	tx_inclock,
	...
	CL_ALTLVDS_Tx_1_altclkctrl1   coreclk_buf
	( 
	.inclk({{3{1'b0}}, wire_lvds_tx_pll_clk[2]}),
	.outclk(wire_coreclk_buf_outclk));
	CL_ALTLVDS_Tx_1_ddio_out1   ddio_out
	( 
	.datain_h(l_input),
	.datain_l(h_input),
	...
	CL_ALTLVDS_Tx_1_cmpr1   cmpr10
	( 
	.aeb(wire_cmpr10_aeb),
	.dataa(dffe4a),
	.datab(dffe8a));
	CL_ALTLVDS_Tx_1_cmpr1   cmpr9
	( 
	.aeb(wire_cmpr9_aeb),
	.dataa(dffe3a),
	.datab(dffe7a));
	CL_ALTLVDS_Tx_1_cntr1   cntr2
	( 
	.clock(fast_clock),
	.q(wire_cntr2_q),
	.updown(sync_dffe1a));
	CL_ALTLVDS_Tx_1_shift_reg1   shift_reg12
	( 
	.clock(fast_clock),
	...
	CL_ALTLVDS_Tx_1_shift_reg1   shift_reg13
	( 
	.clock(fast_clock),
	...
	defparam
		...
		lvds_tx_pll.clk2_phase_shift = "1000",
...
endmodule //CL_ALTLVDS_Tx_1_lvds_tx1
//VALID FILE
