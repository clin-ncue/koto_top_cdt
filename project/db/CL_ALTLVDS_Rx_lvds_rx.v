//altlvds_rx CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" COMMON_RX_TX_PLL="OFF" CYCLONEII_M4K_COMPATIBILITY="ON" DESERIALIZATION_FACTOR=6 DEVICE_FAMILY="Stratix II" ENABLE_DPA_MODE="OFF" IMPLEMENT_IN_LES="OFF" INCLOCK_PERIOD=8000 INCLOCK_PHASE_SHIFT=0 INPUT_DATA_RATE=750 NUMBER_OF_CHANNELS=1 OUTCLOCK_RESOURCE="AUTO" REGISTERED_OUTPUT="ON" USE_EXTERNAL_PLL="OFF" rx_in rx_inclock rx_out rx_outclock CARRY_CHAIN="IGNORE" CARRY_CHAIN_LENGTH=48 LOW_POWER_MODE="AUTO" ALTERA_INTERNAL_OPTIONS=AUTO_SHIFT_REGISTER_RECOGNITION=OFF
...
//CBXI_INSTANCE_NAME="sigma_delta_CL_ALTLVDS_Rx_inst21_altlvds_rx_altlvds_rx_component"
...
module  CL_ALTLVDS_Rx_altclkctrl
	( 
	inclk,
...
`endif
	...
	assign
		...
		inclk_wire = {inclk},
		outclk = wire_clkctrl3_outclk;
endmodule //CL_ALTLVDS_Rx_altclkctrl

//synthesis_resources = clkctrl 1 reg 6 stratixii_lvds_receiver 1 stratixii_pll 1 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
(* ALTERA_ATTRIBUTE = {"AUTO_SHIFT_REGISTER_RECOGNITION=OFF;REMOVE_DUPLICATE_REGISTERS=OFF;{-to pll} AUTO_MERGE_PLLS=OFF;-name SOURCE_MULTICYCLE 6 -from wire_rx_dataout* -to rxreg*;-name SOURCE_MULTICYCLE_HOLD 6 -from wire_rx_dataout* -to rxreg*"} *)
module  CL_ALTLVDS_Rx_lvds_rx
	( 
	rx_in,
	rx_inclock,
	rx_out,
	...
	CL_ALTLVDS_Rx_altclkctrl   rx_outclock_buf
	( 
	...
	defparam
		pll.clk0_divide_by = 6,
		pll.clk0_multiply_by = 6,
		pll.clk0_phase_shift = "-666",
		pll.compensate_clock = "lvdsclk",
		pll.inclk0_input_frequency = 8000,
		pll.operation_mode = "normal",
		pll.pll_type = "fast",
		pll.sclkout0_phase_shift = "-666",
		pll.vco_divide_by = 1,
		pll.vco_multiply_by = 6,
	...
	assign
		...
		rx_pll_enable = 1'b1;
endmodule //CL_ALTLVDS_Rx_lvds_rx
//VALID FILE
